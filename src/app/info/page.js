  ...
  return (
    <div>
      ...
      <section className="text-center p-12">
        <h2 className="text-xl font-bold mb-4 text-gray-800">Our Mission Is Simple: To Provide Access to the Written Word for Everyone Who Walks Through Our Doors</h2>
      ...
      <section className="text-center py-12">
        <h3 className="text-lg font-bold mb-4 text-gray-800">Services Offered</h3>
      ...
      <section className="py-12 max-w-4xl mx-auto">
        <h3 className="text-lg text-gray-800 font-bold text-center mb-6">Community Initiatives</h3>
      ...
      <section className="bg-yellow-500 text-white text-center p-8 mt-12 grid grid-cols-2 items-center max-w-4xl mx-auto rounded-lg">
        <div>
          <h3 className="text-lg font-bold">Join Our Library Community</h3>
          <p className="text-sm">Become a part of our vibrant library programs and volunteer opportunities. Sign up to make a difference and connect with fellow book lovers today!</p>
          <button className="bg-white text-yellow-500 px-4 py-2 rounded-lg">Join for Free</button>
        </div>
        <Image src="/info/community.png" width={1000} height={1000} className="rounded-md" alt="Book Fair" />
      </section>
    </div>
  );
}
